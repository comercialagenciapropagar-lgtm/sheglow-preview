...
|   |-- Glow Skin              Colageno em po 360g, firmeza
|   |-- Glow Energy            Energia sustentada, disposicao
|   |-- Glow Imune & Articula  Imunidade + articulacoes (curcuma + colageno tipo 2)
|   |-- Glow Fit               Detox, digestao, equilibrio
|
|-- GLOW PHASES (Diferencial — moat competitivo)
|   |-- Glow Ciclo             Ciclo menstrual (2 frascos por fase)
|   |-- Glow Mama              Gestacao e pos-parto
|   |-- Glow Plena             Perimenopausa e menopausa
|
|-- GLOW RITUALS (Futuro — experiencia)
|   |-- Glow Manha             Sache matinal dissolvivel
|   |-- Glow Noite             Gummies premium noturnos
```

### Regra de naming
Sempre **"Glow + palavra"** separado por espaco. Pode misturar ingles popular (Hair, Skin, Energy, Fit) + PT-BR (Imune). Pode ter co-nome funcional com "&". Sempre pela **transformacao**, nunca pelo ingrediente.
- Certo: Glow Hair, Glow Imune & Articula, Glow Fit
- Errado: GlowHair (sem espaco), MagGlow (ingrediente), CollaGlow (ingrediente)
...
**Cores por produto (Essentials):**

| Produto | Hex | Aplicacao |
|---|---|---|
| Glow Hair             | `#A64D5F` (Rose Profundo)  | Faixa topo, logo, destaques |
| Glow Skin             | `#8A9B6E` (Sage Oliva)     | Faixa topo, logo, destaques |
| Glow Energy           | `#B0583D` (Terracota)      | Faixa topo, logo, destaques |
| Glow Imune & Articula | `#B8893C` (Ambar/Dourado)  | Faixa topo, logo, destaques |
| Glow Fit              | `#6B2E3F` (Bordo/Vinho)    | Faixa topo, logo, destaques |

**Cores por fase (Glow Phases):**

| Fase | Hex | Significado |
|---|---|---|
| Glow Ciclo | `#B89AA8` (Rose profundo)   | Ciclo, renovacao |
| Glow Mama  | `#C4929A` (Rose)            | Maternidade, acolhimento |
| Glow Plena | `#9E8FB8` (Lavanda)         | Sabedoria, transicao, poder |
...
```
Glow Hair:              #F2D6DC → #C77887 → #A64D5F
Glow Skin:              #D9DFCA → #ABB68F → #8A9B6E
Glow Energy:            #ECC6B7 → #C8846B → #B0583D
Glow Imune & Articula:  #EBD4A4 → #CBA765 → #B8893C
Glow Fit:               #C89AA3 → #8C4857 → #6B2E3F
```
...
3. Nome do produto (Glow Hair, Glow Skin, etc) — destaque principal
